...
public:
    ...
    ADD_METHOD_TO(DockerController::getContainers,
                  "/docker/containers",
                  drogon::Get);
    ADD_METHOD_TO(DockerController::getPostgresContainers,
    ...
    void getContainers(const drogon::HttpRequestPtr &req,
                       std::function<void(const drogon::HttpResponsePtr &)> &&callback);

    void getPostgresContainers(const drogon::HttpRequestPtr &req,
                               std::function<void(const drogon::HttpResponsePtr &)> &&callback);

    void startContainer(const drogon::HttpRequestPtr &req,
                        std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                        const std::string &container_id);

    void stopContainer(const drogon::HttpRequestPtr &req,
                       std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                       const std::string &container_id);
